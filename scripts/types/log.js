...
function Log (data = { code: '-400' }) {
  ...
  this.sector = ['misc', 'audio', 'visual', 'research', 'physical', 'misc'][this.sc]
  ...
  this.tasks = [
    ...
    ['idle', 'meditation', 'walking', 'running', 'cardio', 'strenuous activity', 'workout', 'gym time', 'partnered workout', 'group workout']
  ]
