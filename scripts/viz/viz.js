...
function Viz (logs, from, to, showDetails = true) {
  ...
  function _legend (logs) {
    ...
    const sum = horaire.sectors.audio + horaire.sectors.visual + horaire.sectors.research + horaire.sectors.physical
    ...
    <rect class="physical" x="${(cell + 1) * 26}" y="115" width="13" height="13" rx="2" ry="2" title="17O11"></rect>
    <text x='${(cell + 1) * 28}' y='125' style='text-anchor:start'>Physical ${_perc(horaire.sectors.physical, sum)}%</text>
